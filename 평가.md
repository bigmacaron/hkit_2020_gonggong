...
* 설치 결과
```console
Requirement already satisfied: flask in /home/hkit14/.local/lib/python3.8/site-packages (1.1.2)
...
Requirement already satisfied: Werkzeug>=0.15 in /home/hkit14/.local/lib/python3.8/site-packages (from flask) (1.0.1)
Requirement already satisfied: itsdangerous>=0.24 in /home/hkit14/.local/lib/python3.8/site-packages (from flask) (1.1.0)
```
